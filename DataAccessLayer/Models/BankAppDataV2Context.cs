...
public partial class BankAppDataV2Context : IdentityDbContext
{
    public BankAppDataV2Context()
    {
    }

    public BankAppDataV2Context(DbContextOptions<BankAppDataV2Context> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=localhost;Database=BankAppDataV2;Trusted_Connection=True;TrustServerCertificate=true;");
