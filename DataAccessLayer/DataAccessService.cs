...
namespace DataAccessLayer
{
    ...
    {
        private readonly Func<BankAppDataContext> _contextFactory;
        private readonly BankAppDataContext _context;
        public DataAccessService(Func<BankAppDataContext> contextFactory)
        {
        ...
        public List<int> GetCustomerIdByCountry(Country country)
        {
            try
            {
                ...
                return _context.Dispositions
                   .Where(d => (int)d.Customer.Country == countryValue)
        ...
        public int GetAccountCountByCountry(Country country)
        {
            ...
            {
                return _context.Dispositions
                    .Where(d => (int)d.Customer.Country == (int)country)
